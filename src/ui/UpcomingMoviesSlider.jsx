...
import { UpcomingNextArrow, UpcomingPrevArrow } from './CustomSliderArrow';

import styles from './styled/upcoming-movies.module.css';

export default function UpcomingMoviesSlider({ slides }) {
  const settings = {
    infinite: false,
    speed: 500,
    slidesToScroll: 4,
    slidesToShow: 5,
    nextArrow: <UpcomingNextArrow />,
    prevArrow: <UpcomingPrevArrow />,
  };
  return (
    <Slider {...settings}>
      {slides.map((slide) => (
