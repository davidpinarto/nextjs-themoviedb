...
import { PopularNextArrow, PopularPrevArrow } from './CustomSliderArrow';

import styles from './styled/popular-movies.module.css';

export default function PopularMoviesSlider({ slides }) {
  const settings = {
    infinite: false,
    speed: 500,
    slidesToScroll: 4,
